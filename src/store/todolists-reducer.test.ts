...
test('correct todolist should add items', () => {
    ...
    const endState = todolistReducer(startState, {type: 'ADD-TODOLIST', id: todolistId1, title: newTextTitle})
...
test('correct todolist should change it is name', () => {
    ...
    let newTextTitle = 'New text'
    const endState = todolistReducer(startState, {type: 'CHANGE-TODOLIST-TITLE', id: todolistId1, title: newTextTitle})
